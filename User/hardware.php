...
<section class="hardware">
  <div class="container-fluid">
    ...
    <div class="px-lg-5"> 
      ...
      <!-- Gallery item -->
      <?php  
              $query = mysqli_query($con, "Select * from products Where Category ='Hardware'"); // SQL Query 
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                <div class="bg-white rounded shadow-sm">
                  <div class="img-hardware">
                    <a href="data:image;base64,<?php echo base64_encode($row['Image'])?>" data-toggle="lightbox">
